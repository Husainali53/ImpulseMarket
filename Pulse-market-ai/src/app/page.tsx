    ...
    return (
        <main className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white">
            ...
            <div className="relative z-10">
                {/* Header */}
                <header className="fixed top-0 w-full bg-black/20 backdrop-blur-lg border-b border-white/10">
                    <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
                        <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                            Pulse Markets AI
                        </h1>
                        <button className="bg-blue-600 hover:bg-blue-500 px-6 py-2 rounded-full transition-all hover:scale-105">
                            Get Pro
                        </button>
                    </div>
                </header>
                ...
                <section className="pt-32 pb-20 px-6 text-center">
                    ...
                    <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-8">
                        Real-time analysis and expert picks for smarter investing
                    </p>
                    <button className="bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 px-8 py-4 rounded-full font-semibold text-lg transition-all hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50">
                        Start Free Trial
                    </button>
                </section>
...
function MarketCard({ title, value, change, positive }: { title: string; value: string; change: string; positive: boolean }) {
    return (
        <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all hover:scale-102">
